...
class _RecruitmentPostService implements RecruitmentPostService {
  ...
  @override
  Future<NearbyPost> getNearbyPost(lng, lat, textSearch, map) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'lng': lng,
      r'lat': lat,
    ...
    _data.addAll(map);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NearbyPost>(
            Options(method: 'POST', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/recruitment-post/nearby',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = NearbyPost.fromJson(_result.data!);
    return value;
  }

  @override
  Future<HomeSearchPost> getHomeSearchPost(textSearch, map) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'text_search': textSearch};
    final _data = <String, dynamic>{};
    _data.addAll(map);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HomeSearchPost>(
            Options(method: 'POST', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/recruitment-post/search',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = HomeSearchPost.fromJson(_result.data!);
    return value;
  }
